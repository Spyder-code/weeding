    ...
    <div class="row">
        ...
        <div class="col-12 mb-2">
            <div class="card p-3 shadow-lg">
                ...
                <hr>
                <form action="{{ route('weeding-invitation.import') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="weeding_id" value="{{ $weeding->id }}">
                    <div class="d-flex">
                        <div class="mb-2">
                ...
                <table class="table w-100 dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->name }}</td>
                            <td>{{ $item->phone }}</td>
                            <td>{{ $item->send_message_status }}</td>
