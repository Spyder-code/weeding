...
class CreateRepositories extends Command
{
    ...
    {
        $content = "<?php\r\n\r\nnamespace App\\Repositories;\r\n\r\nuse App\\Models\\".$model_name.";\r\nuse Yajra\\DataTables\\DataTables;\r\n\r\nclass ".$model_name."Service extends Repository\r\n{\r\n\r\n    public function __construct()\r\n    {\r\n        ".'$this->model'." = new ".$model_name.";\r\n    }\r\n\r\n    public function dataTable()\r\n    {\r\n        return DataTables::of(".'$this->model->all()'.")\r\n            ->addColumn('action', function (".'$data'.") {\r\n                return '<a href=\"' . route('".strtolower($model_name).".edit', ".'$data->id'.") . '\" class=\"btn btn-primary btn-sm\"><i class=\"bx bx-pencil\"></i></a>\r\n                        <form action=\"' . route('".strtolower($model_name).".destroy', ".'$data->id'.") . '\" method=\"POST\" class=\"d-inline\">\r\n                            <input type=\"hidden\" name=\"_method\" value=\"DELETE\">\r\n                            <input type=\"hidden\" name=\"_token\" value=\"' . csrf_token() . '\">\r\n                            <button class=\"btn btn-danger btn-sm\" onclick=\"return confirm(\\'are yous sure?\\')\"><i class=\"bx bx-trash-alt\"></i></button>\r\n                        </form>';\r\n            })\r\n            ->rawColumns(['action'])\r\n            ->make(true);\r\n    }\r\n}";
